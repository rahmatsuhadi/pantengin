...
export default function EmptyState({ isSearching, query }: { isSearching: boolean; query: string }) {
    return (
        <div className="flex flex-col items-center justify-center py-24 text-center">
            ...
            <h3 className="font-display font-semibold text-text-primary text-xl mb-2">No Results</h3>
